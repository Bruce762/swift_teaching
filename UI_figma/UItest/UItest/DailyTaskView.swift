...
struct DailyTaskView: View {
    @State private var tasks = [
        Task(title: "線性代數", note: "備註", time: "整天", color: Color(red: 0.7, green: 0.16, blue: 0.13).opacity(0.4)),
        Task(title: "離散數學", note: "備註", time: "整天", color: Color(red: 0.7, green: 0.56, blue: 0).opacity(0.4)),
        Task(title: "資料結構", note: "備註", time: "10:00 ~ 21:00", color: Color(red: 0.18, green: 0.7, blue: 0.31).opacity(0.4)),
        Task(title: "計算機結構", note: "備註", time: "22:00 ~ 23:00", color: Color(red: 0.29, green: 0.28, blue: 0.7).opacity(0.4)),
    ]
